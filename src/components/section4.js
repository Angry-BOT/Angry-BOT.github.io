      ...
      <div className={section4Styles.flex_row}>
        <div className={section4Styles.flex_row1}>
          ...
          <div className={section4Styles.flex_col1}>
            ...
            <img
              className={section4Styles.image19}
              src={"/assets/spring_logo.png"}
              alt="alt text"
            />
            <img
              className={section4Styles.image20}
              src={"/assets/springboot_text.png"}
              alt="alt text"
            />
          </div>
        </div>
        ...
        <div className={section4Styles.flex_col2}>
          ...
          <div className={section4Styles.flex_row2}>
            <div className={section4Styles.flex_col4}>
              ...
              <img
                className={section4Styles.image21}
                src={"/assets/mysql_logo.png"}
                alt="alt text"
              />
              <img
                className={section4Styles.image22}
                src={"/assets/sql_text.png"}
                alt="alt text"
              />
            </div>
            ...
            <div className={section4Styles.flex_col5}>
              ...
              <img
                className={section4Styles.image23}
                src={"/assets/postman_logo.png"}
                alt="alt text"
              />
              <img
                className={section4Styles.image24}
                src={"/assets/postman_text.png"}
                alt="alt text"
              />
            </div>
          </div>
